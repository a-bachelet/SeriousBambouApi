...
export class WelcomeController extends AbstractController {
    ...
    private test(req: Request, res: Response): void {
        ...
        request.post({
            ...
            body: JSON.stringify({url: 'https://gal.img.pmdstatic.net/fit/http.3A.2F.2Fprd2-bone-image.2Es3-website-eu-west-1.2Eamazonaws.2Ecom.2Fprismamedia_people.2F2017.2F06.2F30.2F80fa3a34-4868-4f22-9312-97bfc8d7367c.2Ejpeg/2216x1536/quality/80/francois-hollande.jpg'})
        },
